...
# ------------------------parameters setting
holoPath = r'C:\automated_classification\holographic_plankton_classification-main\samples\test/'
netPath = r'C:\automated_classification\holographic_plankton_classification-main\modelGen\shufflenet_v2_x1_5_10classes_batch326.pt'
classNum = 10
fileType = '.tif'
